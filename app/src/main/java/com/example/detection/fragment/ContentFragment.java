package com.example.detection.fragment;
...
public class ContentFragment extends Fragment implements ScreenShotable {
    public static final String CLOSE = "Close";//over
    public static final String Dashboard = "Dashboard";//delete
    public static final String Calendar = "Calendar";//over//need data
