...
public class testTimeEditPopupFragment extends AppCompatActivity {
    //
    ...
    protected void onCreate(Bundle savedInstance) {
        ...
        datePicker.updateDate(Integer.parseInt(testTimeData.getDate().split("/")[0]),Integer.parseInt(testTimeData.getDate().split("/")[1]),Integer.parseInt(testTimeData.getDate().split("/")[2]));
        numberPicker.setValue(testTimeData.getDuringtime());
        ...
        datePicker.setOnDateChangedListener(new DatePicker.OnDateChangedListener() {
            ...
            public void onDateChanged(DatePicker datePicker, int i, int i1, int i2) {
                testTimeData.setdate(i + "/" + (i1+1) + "/" + i2);
            }
        });
